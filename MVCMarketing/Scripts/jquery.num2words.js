    ...
    $.fn.extend({
        numtowords: function (options) {
            ...
            function NumberToWords() {
                ...
                var getBelowLakh = function (n) {
                    if (n >= 100000) {
                        return "greater than or equal to 100000";
                    };
                    var word = getBelowHundred(Math.floor(n % 1000));

                    n = Math.floor(n / 1000);
                    var hun = Math.floor(n % 10);
                    word = (hun > 0 ? (units[hun] + " Lakh ") : '') + word;
