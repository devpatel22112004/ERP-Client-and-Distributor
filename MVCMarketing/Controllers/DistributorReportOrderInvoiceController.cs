...
{
    public class DistributorReportOrderInvoiceController : Controller
    {
        // GET: DistributorReportOrderInvoice
        ...
        public ActionResult LoadData(Pagination pagination)
        {
            ...
            var InvoiceNumber = pagination.data.columns[1].search.value;
            ...
            SqlCommand com = new SqlCommand("sp_ReportOrderInvoice");
        ...
        public void ExportToExcel(string Date, string InvoiceNumber, string DistributorId, string StartDate, string EndDate, string UserBy)
        {
            SqlCommand com = new SqlCommand("sp_ReportOrderInvoice");
            com.CommandType = CommandType.StoredProcedure;
            com.Parameters.AddWithValue("@Date", Date == "" ? null : Date);
            ...
            if (dt != null)
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=ReportOrderInvoice-" + DateTime.Now.ToString("MM/dd/yyyyHH:mm") + ".xls");
        ...
        public void ExportToExcel1(string InvoiceId)
        {
            SqlCommand com = new SqlCommand("sp_ReportOrderInvoice");
            com.CommandType = CommandType.StoredProcedure;
            ...
            Response.ClearContent();
            Response.AddHeader("content-disposition", "attachment;filename=ReportOrderInvoiceItem-" + DateTime.Now.ToString("MM/dd/yyyyHH:mm") + ".xls");
            Response.AddHeader("Content-Type", "application/vnd.ms-excel");
            if (dt != null)
            {

                Response.Write("Invoice Order Information");
                Response.Write(makeExcelData(dt));
            }
            if (dt1 != null)
            {
                Response.Write("Invoice Item Information");
