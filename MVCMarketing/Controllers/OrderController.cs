    ...
    public class OrderController : Controller
    {
        ...
        public ActionResult Cancel(string id)
        {
            if (id != null)
            {
                ...
                com.CommandType = CommandType.StoredProcedure;
                com.Parameters.AddWithValue("@OrderId", id);
                com.Parameters.AddWithValue("@Action", "SELECTSINGLE-CANCEL");
                DataTable dt = ConnectionClass.getDataTable(com);
                if (dt != null)
                {
                    string JSONString = string.Empty;
        ...
        public JsonResult Insert(FormCollection formCollection)
        {
            try
            {
                ...
                com.Parameters.AddWithValue("@Lat", formCollection["hdLat"]);
                com.Parameters.AddWithValue("@Log", formCollection["hdLng"]);
        ...
        [HttpPost]
        public JsonResult InsertCancel(FormCollection formCollection)
        {
            try
            {
                SqlCommand com = new SqlCommand("sp_Order");
                com.CommandType = CommandType.StoredProcedure;
                com.Parameters.AddWithValue("@OrderId", formCollection["hdOrderId3"]);
                com.Parameters.AddWithValue("@CancelReason", formCollection["txtCancelRemark"]);
                com.Parameters.AddWithValue("@Action", "INVOICE-CANCEL");
                return ConnectionClass.DML(com);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult LoadData(Pagination pagination)
        {
            ...
            var CancelStatus = pagination.data.columns[4].search.value;
            ...
            com.Parameters.AddWithValue("@CancelStatus", CancelStatus == "" ? null : CancelStatus);
